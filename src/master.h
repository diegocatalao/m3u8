 ...
 * @param[out] master A pointer to a @ref m3u8_master_t structure that will be populated with the
 *                    parsed data.
 ...
 * @return @ref M3U8_STATUS_INVALID_MASTER_PLAYLIST if the playlist fails validation.
 */
