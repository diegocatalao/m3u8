...
TEST(m3u8_list_test, given_a_list_set_next_prev_as_head) {
  ...
  EXPECT_EQ(m3u8_list_init(&head), M3U8_LINKED_STATUS_NO_ERROR);
...
TEST(m3u8_list_insert_after, insert_node) {
  ...
  EXPECT_EQ(m3u8_list_insert_after(&head, &node), M3U8_LINKED_STATUS_NO_ERROR);
...
TEST(m3u8_list_insert_after, inserts_multiple_nodes) {
  ...
  EXPECT_EQ(m3u8_list_insert_after(&head, &node1), M3U8_LINKED_STATUS_NO_ERROR);
  ...
  EXPECT_EQ(m3u8_list_insert_after(&head, &node2), M3U8_LINKED_STATUS_NO_ERROR);
...
TEST(m3u8_list_insert_before, insert_node) {
  ...
  m3u8_linked_node_t node;
  memset(&node, 0, sizeof(m3u8_linked_node_t));
  EXPECT_EQ(m3u8_list_insert_before(&head, &node), M3U8_LINKED_STATUS_NO_ERROR);
...
TEST(m3u8_list_insert_before, inserts_multiple_nodes) {
  ...
  m3u8_linked_node_t node1;
  memset(&node1, 0, sizeof(m3u8_linked_node_t));
  EXPECT_EQ(m3u8_list_insert_before(&head, &node1),
  ...
  m3u8_linked_node_t node2;
  memset(&node2, 0, sizeof(m3u8_linked_node_t));
  EXPECT_EQ(m3u8_list_insert_before(&head, &node2),
            M3U8_LINKED_STATUS_NO_ERROR);
...
TEST(m3u8_list_remove_test, given_valid_node_removes_node_from_list) {
  ...
  // remove node 1
  EXPECT_EQ(m3u8_list_remove(&node1), M3U8_LINKED_STATUS_NO_ERROR);
...
TEST(m3u8_list_empty_test, given_empty_list_returns_true) {
  ...
  EXPECT_EQ(m3u8_list_is_empty(&head, &empty), M3U8_LINKED_STATUS_NO_ERROR);
  EXPECT_TRUE(empty);
}
...
TEST(m3u8_list_count_test, given_empty_list_returns_zero) {
  ...
  EXPECT_EQ(m3u8_list_count(&head, &size), M3U8_LINKED_STATUS_NO_ERROR);
  EXPECT_EQ(size, 0);
}
...
TEST(m3u8_list_container_of, return_currect_container_pointer) {
  ...
  EXPECT_EQ(m3u8_list_init(&generic.list), M3U8_LINKED_STATUS_NO_ERROR);
...
TEST(m3u8_list_foreach, iterates_over_list_from_container) {
  ...
  EXPECT_EQ(m3u8_list_init(&generics[0].list), M3U8_LINKED_STATUS_NO_ERROR);
